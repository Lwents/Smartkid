...
import com.example.smartkid.ui.profile.ChangePasswordActivity;
import com.example.smartkid.ui.profile.ProfileEditActivity;
...
public class RolePortalActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.activity_role_portal);
